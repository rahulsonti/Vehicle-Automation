...
namespace c2d_console
{
    class Program
    {
        ...
        //check this once!!
        static string connectionString = "HostName=CyberTech.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=AdgUR0SNZpzDxdM0L/hWP5LlWSsDTgQlCy1fKlrAQ7Y=";
